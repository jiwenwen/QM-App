...
*/
        ...
        returnPreview:function(){
          /* history.back();*/
            ...
            var $isall = util._param.isall ? util._param.isall:0;
            if (util._param.search){
                window.location.href="proList.html?search="+util._param.search+"&status="+$status+"&isall="+$isall;
            }
            else
            {
                window.location.href="proList.html?status="+$status+"&isall="+$isall;
            }
        },
        /*点击列表进入详情*/
